...
const getweather = async (e) => {
  ...
  const response = await fetch(
    `https://api.weatherapi.com/v1/forecast.json?key=af69b7e7129545d9aed181641240505&q=${input.value}&days=10&aqi=yes&alerts=yes`
  );
  ...
  humiditytext2.innerText =
    data.forecast.forecastday[0].hour[11].humidity + "%";
